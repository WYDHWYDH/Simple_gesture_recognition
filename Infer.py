...
class Inferhand():
    ...
    def detect(self, Hand_key_points):
        ...
        return Inferhand.IndexPredicted[predicted]
        # gesture_fist = [
        #     all([Hand_key_points.landmark[mp_hands.HandLandmark(0).value].y > Hand_key_points.landmark[
        #         mp_hands.HandLandmark(i).value].y > Hand_key_points.landmark[mp_hands.HandLandmark(i - 3).value].y - 0.02
        #          for i in [8, 12, 16, 20]]),
        #     all([Hand_key_points.landmark[mp_hands.HandLandmark(0).value].y > Hand_key_points.landmark[
        #         mp_hands.HandLandmark(i).value].y > Hand_key_points.landmark[mp_hands.HandLandmark(i - 2).value].y - 0.02
        #          for i in [7, 11, 15, 19]]),
        # ]
